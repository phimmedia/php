...
<meta charset="UTF-8">
<center>
<div style="width: 100%px; height: 100%px; position: relative;">
<div class="contentpost">
<div id="videoembedder">
<div id="embed_holder"><div class="player-embed" id="pembed">	<script type="text/javascript" src="https://content.jwplatform.com/libraries/UPmlUjaP.js"></script>
<div id="jwplayer-1492449733"></div>
<script type="text/javascript">
jwplayer("jwplayer-1492449733").setup({
sources: [{file:"https://www.googleapis.com/drive/v3/files/<?=$_GET['id']?>?alt=media&key=AIzaSyBFHimHWDyLOtcNJjA268KwRLhsBuckUxc",label:"360p","type":"mp4","default": "true",label:"720p","type":"mp4"}],
skin: "prime",
autostart: "false",
...
primary: "html5",
tracks: [{
//file: "https://dl.dropboxusercontent.com/s/oyb3nwwnzog5pss/Wonder%20Woman%20Bloodlines.vtt?dl=0",
label: "VietNam",
kind:  "captions",
default: "true",
}],
