...
console.log(arrPreroll);
	var sources = [{file: 'https://ok.ru/videoembed/1993819818662',
				type:'embed',
				label: '720p',
				default: false},];
	var tracks = [];
	...
	function setupVideo(){		
		var firstSource = [{file: 'http://embedapi.herokuapp.com/vast15s/embed/1s_blank.mp4',type:'mp4',label: '360p',default: true}];	
		...
		console.log(maxAds);
			...
			playerInstance.setup({				
				...
				controls: true,
				//aspectratio: '16:9',
				flashplayer: 'http://embedapi.herokuapp.com/vast15s/embed/jwplayer.flash.swf',
				autostart: true,	
