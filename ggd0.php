...
<body>
    ...
    <iframe src="https://drive.google.com/file/d/<?=$_GET['phimmedia']?>/preview" scrolling="no" frameborder="0" width="100%" height="100%" allowfullscreen="true" webkitallowfullscreen="true" mozallowfullscreen="true"></iframe>
